...
void _start() {
    ...
    cookie_t cookie;
    app_start(&cookie);
    event_t event_message;
    event_message.cookie = &cookie;
    event_message.fct = (void*)event_afficher;

    core_disable_irqs();
    queue_put(event_message);
    core_enable_irqs();
